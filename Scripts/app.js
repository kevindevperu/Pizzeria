...
//Función que guarda el carrito en el localStorage
function guardarCarritoEnLocalStorage() {
    var itemsCarrito = document.getElementsByClassName('carrito-items')[0];
    var items = itemsCarrito.getElementsByClassName('carrito-item');
    var carrito = [];
...
//Función que carga el carrito desde el localStorage
function cargarCarritoDesdeLocalStorage() {
    var carrito = JSON.parse(localStorage.getItem('carrito'));
    for (var i = 0; i < carrito.length; i++) {
        var item = carrito[i];
        agregarItemAlCarrito(item.titulo, item.precio, item.imagenSrc);
        var cantidadInput = document.getElementsByClassName('carrito-item-cantidad')[i];
